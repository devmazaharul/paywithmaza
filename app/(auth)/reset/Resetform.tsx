...
export default function Resetform() {
  ...
  const {register,formState:{errors},handleSubmit,setError}=useForm<ResetField>({
  ...
  try {
    const response = await http_instance.post("/genarateapikey", data,{withCredentials:true});
